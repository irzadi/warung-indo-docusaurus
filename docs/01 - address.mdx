...
|Teman kamu/anda |Your friend|  
|Teman mereka|Their friend|
|Temannya|His/her friend|

Indonesian doesn't have possessive pronoun, we simply combine the word "punya" or "milik" with possessive e.g.:

|EN          |ID            |note|
|----------------|-------------------------------|-----------------------------|
|Mine |Milik/punya saya|
|Yours|Milik/punya kamu|  
|His/Hers|Milik/punya dia|
|Theirs|Milik/punya mereka|
